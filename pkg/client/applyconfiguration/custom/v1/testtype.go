...
type TestTypeApplyConfiguration struct {
	...
	*metav1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                                 *TestSpecApplyConfiguration `json:"spec,omitempty"`
}
...
func (b *TestTypeApplyConfiguration) WithSpec(value *TestSpecApplyConfiguration) *TestTypeApplyConfiguration {
	b.Spec = value
	return b
}
